...
**Review protection.** Before semantic adjudication, the same canonical representation is fetched again and compared to that verified commitment. Source/usage use screenshot bytes; terms/counter evidence use UTF-8 rendered text.
...
**Deployment/source.** This implementation has not yet been redeployed; add the new StudioNet address, transaction, and final commit SHA after an authorized deploy and push.
