...
export function WalletButton() {
  ...
  return (
    <div className="flex max-w-full items-start justify-end">
      <div className="flex w-full max-w-[180px] flex-col gap-1 rounded-lg border border-vault-300/15 bg-vault-900/70 p-1 shadow-inner shadow-black/20 sm:max-w-[190px]">
        {address ? (
