...
Evidence can be submitted through the challenge close date. After that date, verified material is classified as within scope, minor overreach, material breach, or undetermined. Deterministic settlement is respectively 100/0, 80/20, 0/100 publisher/creator, or existing publisher recovery for an undetermined result. Expiry and unaccepted-release recovery remain available.
